...
export default function KaleidoscopeTechStack() {
  ...
  const techIcons = [
    ...
    { src: '/images/git.png', alt: 'Git', link: 'https://gitlab.com/mattadlerpdx' }, // 👈 added link
  ];
  ...
  return (
    ...
    >
      {/* Center icon */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-full shadow-md p-3 z-10 animate-glow-pulse">
        <svg
          width="36"
          height="36"
          viewBox="0 0 24 24"
